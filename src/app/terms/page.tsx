...
const sections = {
  ...
  en: [
    ...
    { title: "Payments and plans", icon: CreditCard, copy: ["Prices and conditions are confirmed before lessons begin. Bank transfers and online debit or credit card payments are accepted.", "A 10-day grace period applies after the end of each month. A RD$300 late fee may apply afterward. Service may be paused after two unpaid months until the balance is resolved."] },
