...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createLocalizedMetadata({
    ...
    ...(locale === "en"
      ...
      : { title: "Sobre Alberto | Alberto Academy", description: "Conozca a Alberto A. Sosa, licenciado en Lenguas Modernas, su experiencia con más de 400 estudiantes y su Método Directo & por Asociación para enseñar idiomas." }),
  });
}
...
const copy = {
  es: {
    ...
    ], journeyAlt: "Alberto preparando materiales para sus clases de idiomas", journeyBadge: "Experiencia docente", journeyPlace: "Impact Language Institute y O&M English Program",
  ...
  en: {
    ...
    introImageAlt: "Alberto A. Sosa, founder and language teacher at Alberto Academy", introImageKicker: "Dominican Republic", introImageTitle: "Modern Languages Graduate", introKicker: "Alberto A. Sosa", introTitle: "Academic training translated into practical, human instruction.", introParagraphs: ["Alberto holds a degree in Modern Languages and has more than four years of teaching experience. He has taught over 400 students, from age nine through adulthood.", "His experience includes O&M Hostos School, Impact Language Institute, and the O&M English Program.", "He created Alberto Academy so learners can study from anywhere with serious, flexible instruction. For English speakers, that means learning Spanish with a teacher who understands both languages and the cultural context behind them."], badges: ["Degree in Modern Languages", "English Immersion Diploma", "Impact Language Institute Training", "Direct & Association Method"],
    ...
    ], journeyAlt: "Alberto preparing materials for his language lessons", journeyBadge: "Teaching experience", journeyPlace: "Impact Language Institute and O&M English Program",
