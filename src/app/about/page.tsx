...
const copy = {
  ...
  en: {
    ...
    introImageAlt: "Alberto A. Sosa, founder and language teacher at Alberto Academy", introImageKicker: "Dominican Republic", introImageTitle: "Modern Languages Graduate", introKicker: "Alberto A. Sosa", introTitle: "Academic training translated into practical, human instruction.", introParagraphs: ["Alberto holds a degree in Modern Languages and has more than four years of teaching experience. He has taught over 400 students, from age nine through adulthood.", "His experience includes O&M Hostos School, Impact Language Institute, and the O&M English Program. He currently teaches at Impact Language Institute and in O&M's English program.", "He created Alberto Academy so learners can study from anywhere with serious, flexible instruction. For English speakers, that means learning Spanish with a teacher who understands both languages and the cultural context behind them."], badges: ["Degree in Modern Languages", "English Immersion Diploma", "Impact Language Institute Training", "Direct & Association Method"],
